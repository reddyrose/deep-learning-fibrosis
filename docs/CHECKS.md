...
- **Notebooks:** all 13 `.ipynb` files are valid JSON. Cell outputs, `execution_count`, and Colab-specific metadata (`colab`, `executionInfo`, `outputId`) are cleared from every notebook; source cells are otherwise unmodified.
