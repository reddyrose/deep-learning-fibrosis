...
##------------------------------------------------------------------
mr_table      <- file.path(BASE_DIR, "shriya/MR_experiment/completed_MR_2/significant_associations.txt")
cis_root      <- file.path(BASE_DIR, "shriya/all_protiens_cispQTL")
gwas_root     <- file.path(BASE_DIR, "shriya/SHMOLLI_hg38_converted_GWASs/T1_percentiles_HHregressed")
...
outfile <- sprintf("coloc_results_%s.tsv.gz", tag)
