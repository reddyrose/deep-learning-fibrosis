...
The seven main figures as they appear in the manuscript (Figure 1-7). Each combines panels generated by `01_Fibrosis_Figures.ipynb` (below) with additional schematic and illustrative elements assembled outside this repository.
